...
2. Report only material items not already captured in Git, committed documents, reports, or completed implementation:
   ...
   - Private notes that belong in the untracked `internal/` area.
...
The closeout report is expected to be stored privately (in `internal/logs/` or another agreed location) unless Buddy decides otherwise.
