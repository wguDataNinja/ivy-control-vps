...
- A local implementation agent contract is defined in `agents/LOCAL_IMPLEMENTATION.md`. The VPS/Hermes orchestration contract, permissions, routing, and repository-local contracts for non-local contexts remain pending.
...
- **VPS/Hermes orchestration contract** — agent capabilities, permissions, routing, and communication protocol for non-local contexts.
