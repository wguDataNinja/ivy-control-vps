...
```sh
# Managed repositories: purpose, lifecycle, control-record health/review state, blocker, and next work.
./tools/show_portfolio_status.sh --no-color

# Operational evidence: current observations, explicit evidence-card input, and explicit UNKNOWN states.
